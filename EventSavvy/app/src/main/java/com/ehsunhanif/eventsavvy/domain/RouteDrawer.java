...
// The code below has been taken/inspired by https://stackoverflow.com/q/14444228
public class RouteDrawer {
    ...
    public Document getDocument(LatLng start, LatLng end, String mode) {
        String googleMapUrl = "http://maps.googleapis.com/maps/api/directions/xml?"
                + "origin=" + start.latitude + "," + start.longitude
                + "&destination=" + end.latitude + "," + end.longitude
                + "&sensor=false&units=metric&mode="+mode;
        Log.d("url", googleMapUrl);
        try {
            URL actionUrl = new URL(googleMapUrl+"&key=AIzaSyABGh98N82xsBN-BLyThifLeRWOR6n5h5w");
