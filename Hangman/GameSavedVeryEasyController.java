...
public class GameSavedVeryEasyController implements Initializable, EventHandler<ActionEvent> {
	...
	@FXML
	TextField first, second, third, fourth, fifth;
	@FXML
	ImageView imgContainer;
	
	String[] array = (String[]) new String[8];
	int imgCount = 0;
	...
	public void handle(ActionEvent myEvent) {
		...
		if(pressedButton == saveGame) {
			String[] incompleteString = new String[8];
		...
		if(pressedButton == a) {
			...
			if (first.getText().equals(String.valueOf(copyString.charAt(0))) && second.getText().equals(String.valueOf(copyString.charAt(1))) && third.getText().equals(String.valueOf(copyString.charAt(2))) && fourth.getText().equals(String.valueOf(copyString.charAt(3))) && fifth.getText().equals(String.valueOf(copyString.charAt(4)))) {
			...
			if(copyString.charAt(0) != 'a' && copyString.charAt(1) != 'a' && copyString.charAt(2) != 'a' && copyString.charAt(3) != 'a' && copyString.charAt(4) != 'a') {
				imgCount++;
				if(imgCount == 9) {
		...
		if(pressedButton == b) {
			...
			if(copyString.charAt(0) != 'b' && copyString.charAt(1) != 'b' && copyString.charAt(2) != 'b' && copyString.charAt(3) != 'b' && copyString.charAt(4) != 'b') {
				imgCount++;
				if(imgCount == 9) {
					first.setText(String.valueOf(copyString.charAt(0)));
					second.setText(String.valueOf(copyString.charAt(1)));
		...
		if(pressedButton == c) {
			...
			if(copyString.charAt(0) != 'c' && copyString.charAt(1) != 'c' && copyString.charAt(2) != 'c' && copyString.charAt(3) != 'c' && copyString.charAt(4) != 'c') {
				imgCount++;
				if(imgCount == 9) {
					first.setText(String.valueOf(copyString.charAt(0)));
					second.setText(String.valueOf(copyString.charAt(1)));
		...
		if(pressedButton == d) {
			...
			if(copyString.charAt(0) != 'd' && copyString.charAt(1) != 'd' && copyString.charAt(2) != 'd' && copyString.charAt(3) != 'd' && copyString.charAt(4) != 'd') {
				imgCount++;
				if(imgCount == 9) {
					first.setText(String.valueOf(copyString.charAt(0)));
					second.setText(String.valueOf(copyString.charAt(1)));
		...
		if(pressedButton == e) {
			...
			if(copyString.charAt(0) != 'e' && copyString.charAt(1) != 'e' && copyString.charAt(2) != 'e' && copyString.charAt(3) != 'e' && copyString.charAt(4) != 'e') {
				imgCount++;
				if(imgCount == 9) {
					first.setText(String.valueOf(copyString.charAt(0)));
					second.setText(String.valueOf(copyString.charAt(1)));
		...
		if(pressedButton == f) {
			...
			if(copyString.charAt(0) != 'f' && copyString.charAt(1) != 'f' && copyString.charAt(2) != 'f' && copyString.charAt(3) != 'f' && copyString.charAt(4) != 'f') {
				imgCount++;
				if(imgCount == 9) {
					first.setText(String.valueOf(copyString.charAt(0)));
					second.setText(String.valueOf(copyString.charAt(1)));
		...
		if(pressedButton == g) {
			...
			if(copyString.charAt(0) != 'g' && copyString.charAt(1) != 'g' && copyString.charAt(2) != 'g' && copyString.charAt(3) != 'g' && copyString.charAt(4) != 'g') {
				imgCount++;
				if(imgCount == 9) {
					first.setText(String.valueOf(copyString.charAt(0)));
					second.setText(String.valueOf(copyString.charAt(1)));
		...
		if(pressedButton == h) {
			...
			if(copyString.charAt(0) != 'h' && copyString.charAt(1) != 'h' && copyString.charAt(2) != 'h' && copyString.charAt(3) != 'h' && copyString.charAt(4) != 'h') {
				imgCount++;
				if(imgCount == 9) {
					first.setText(String.valueOf(copyString.charAt(0)));
					second.setText(String.valueOf(copyString.charAt(1)));
		...
		if(pressedButton == i) {
			...
			if(copyString.charAt(0) != 'i' && copyString.charAt(1) != 'i' && copyString.charAt(2) != 'i' && copyString.charAt(3) != 'i' && copyString.charAt(4) != 'i') {
				imgCount++;
				if(imgCount == 9) {
					first.setText(String.valueOf(copyString.charAt(0)));
					second.setText(String.valueOf(copyString.charAt(1)));
		...
		if(pressedButton == j) {
			...
			if(copyString.charAt(0) != 'j' && copyString.charAt(1) != 'j' && copyString.charAt(2) != 'j' && copyString.charAt(3) != 'j' && copyString.charAt(4) != 'j') {
				imgCount++;
				if(imgCount == 9) {
					first.setText(String.valueOf(copyString.charAt(0)));
					second.setText(String.valueOf(copyString.charAt(1)));
		...
		if(pressedButton == k) {
			...
			if(copyString.charAt(0) != 'k' && copyString.charAt(1) != 'k' && copyString.charAt(2) != 'k' && copyString.charAt(3) != 'k' && copyString.charAt(4) != 'k') {
				imgCount++;
				if(imgCount == 9) {
					first.setText(String.valueOf(copyString.charAt(0)));
					second.setText(String.valueOf(copyString.charAt(1)));
		...
		if(pressedButton == l) {
			...
			if(copyString.charAt(0) != 'l' && copyString.charAt(1) != 'l' && copyString.charAt(2) != 'l' && copyString.charAt(3) != 'l' && copyString.charAt(4) != 'l') {
				imgCount++;
				if(imgCount == 9) {
					first.setText(String.valueOf(copyString.charAt(0)));
					second.setText(String.valueOf(copyString.charAt(1)));
		...
		if(pressedButton == m) {
			...
			if(copyString.charAt(0) != 'm' && copyString.charAt(1) != 'm' && copyString.charAt(2) != 'm' && copyString.charAt(3) != 'm' && copyString.charAt(4) != 'm') {
				imgCount++;
				if(imgCount == 9) {
					first.setText(String.valueOf(copyString.charAt(0)));
					second.setText(String.valueOf(copyString.charAt(1)));
		...
		if(pressedButton == n) {
			...
			if(copyString.charAt(0) != 'n' && copyString.charAt(1) != 'n' && copyString.charAt(2) != 'n' && copyString.charAt(3) != 'n' && copyString.charAt(4) != 'n') {
				imgCount++;
				if(imgCount == 9) {
					first.setText(String.valueOf(copyString.charAt(0)));
					second.setText(String.valueOf(copyString.charAt(1)));
		...
		if(pressedButton == o) {
			...
			if(copyString.charAt(0) != 'o' && copyString.charAt(1) != 'o' && copyString.charAt(2) != 'o' && copyString.charAt(3) != 'o' && copyString.charAt(4) != 'o') {
				imgCount++;
				if(imgCount == 9) {
					first.setText(String.valueOf(copyString.charAt(0)));
					second.setText(String.valueOf(copyString.charAt(1)));
		...
		if(pressedButton == p) {
			...
			if(copyString.charAt(0) != 'p' && copyString.charAt(1) != 'p' && copyString.charAt(2) != 'p' && copyString.charAt(3) != 'p' && copyString.charAt(4) != 'p') {
				imgCount++;
				if(imgCount == 9) {
					first.setText(String.valueOf(copyString.charAt(0)));
					second.setText(String.valueOf(copyString.charAt(1)));
		...
		if(pressedButton == q) {
			...
			if(copyString.charAt(0) != 'q' && copyString.charAt(1) != 'q' && copyString.charAt(2) != 'q' && copyString.charAt(3) != 'q' && copyString.charAt(4) != 'q') {
				imgCount++;
				if(imgCount == 9) {
					first.setText(String.valueOf(copyString.charAt(0)));
					second.setText(String.valueOf(copyString.charAt(1)));
		...
		if(pressedButton == r) {
			...
			if(copyString.charAt(0) != 'r' && copyString.charAt(1) != 'r' && copyString.charAt(2) != 'r' && copyString.charAt(3) != 'r' && copyString.charAt(4) != 'r') {
				imgCount++;
				if(imgCount == 9) {
					first.setText(String.valueOf(copyString.charAt(0)));
					second.setText(String.valueOf(copyString.charAt(1)));
		...
		if(pressedButton == s) {
			...
			if(copyString.charAt(0) != 's' && copyString.charAt(1) != 's' && copyString.charAt(2) != 's' && copyString.charAt(3) != 's' && copyString.charAt(4) != 's') {
				imgCount++;
				if(imgCount == 9) {
					first.setText(String.valueOf(copyString.charAt(0)));
					second.setText(String.valueOf(copyString.charAt(1)));
		...
		if(pressedButton == t) {
			...
			if(copyString.charAt(0) != 't' && copyString.charAt(1) != 't' && copyString.charAt(2) != 't' && copyString.charAt(3) != 't' && copyString.charAt(4) != 't') {
				imgCount++;
				if(imgCount == 9) {
					first.setText(String.valueOf(copyString.charAt(0)));
					second.setText(String.valueOf(copyString.charAt(1)));
		...
		if(pressedButton == u) {
			...
			if(copyString.charAt(0) != 'u' && copyString.charAt(1) != 'u' && copyString.charAt(2) != 'u' && copyString.charAt(3) != 'u' && copyString.charAt(4) != 'u') {
				imgCount++;
				if(imgCount == 9) {
					first.setText(String.valueOf(copyString.charAt(0)));
					second.setText(String.valueOf(copyString.charAt(1)));
		...
		if(pressedButton == v) {
			...
			if(copyString.charAt(0) != 'v' && copyString.charAt(1) != 'v' && copyString.charAt(2) != 'v' && copyString.charAt(3) != 'v' && copyString.charAt(4) != 'v') {
				imgCount++;
				if(imgCount == 9) {
					first.setText(String.valueOf(copyString.charAt(0)));
					second.setText(String.valueOf(copyString.charAt(1)));
		...
		if(pressedButton == w) {
			...
			if(copyString.charAt(0) != 'w' && copyString.charAt(1) != 'w' && copyString.charAt(2) != 'w' && copyString.charAt(3) != 'w' && copyString.charAt(4) != 'w') {
				imgCount++;
				if(imgCount == 9) {
					first.setText(String.valueOf(copyString.charAt(0)));
					second.setText(String.valueOf(copyString.charAt(1)));
		...
		if(pressedButton == x) {
			...
			if(copyString.charAt(0) != 'x' && copyString.charAt(1) != 'x' && copyString.charAt(2) != 'x' && copyString.charAt(3) != 'x' && copyString.charAt(4) != 'x') {
				imgCount++;
				if(imgCount == 9) {
					first.setText(String.valueOf(copyString.charAt(0)));
					second.setText(String.valueOf(copyString.charAt(1)));
		...
		if(pressedButton == y) {
			...
			if(copyString.charAt(0) != 'y' && copyString.charAt(1) != 'y' && copyString.charAt(2) != 'y' && copyString.charAt(3) != 'y' && copyString.charAt(4) != 'y') {
				imgCount++;
				if(imgCount == 9) {
					first.setText(String.valueOf(copyString.charAt(0)));
					second.setText(String.valueOf(copyString.charAt(1)));
		...
		if(pressedButton == z) {
			...
			if(copyString.charAt(0) != 'z' && copyString.charAt(1) != 'z' && copyString.charAt(2) != 'z' && copyString.charAt(3) != 'z' && copyString.charAt(4) != 'z') {
				imgCount++;
				if(imgCount == 9) {
					first.setText(String.valueOf(copyString.charAt(0)));
					second.setText(String.valueOf(copyString.charAt(1)));
